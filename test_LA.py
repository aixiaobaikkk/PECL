...
snapshot_path = "./model/MCCP/LA_{}_{}_labeled/{}".format(FLAGS.exp, FLAGS.labelnum, FLAGS.stage_name)

test_save_path = "./model/MCCP/LA_{}_{}_labeled/{}_predictions/".format(FLAGS.exp, FLAGS.labelnum, FLAGS.model)
num_classes = 2
test_save_path = r'./model/MCCP/LA_{}_{}_labeled/{}_predictions'
if not os.path.exists(test_save_path):
    os.makedirs(test_save_path)
print(test_save_path)
with open(FLAGS.root_path + '/test.list', 'r') as f:
    image_list = f.readlines()
image_list = [FLAGS.root_path + "/2018LA_Seg_Training Set/" + item.replace('\n', '') + "/mri_norm2" for item in image_list]
...
def test_calculate_metric():
    ...
    # for exp in range(5):
    #     print(exp)
    save_model_path = r'E:\PECL\code\model\MCCP\LA_MCCP_16_labeled\exp_10\self_train\VNet_best_model.pth'
